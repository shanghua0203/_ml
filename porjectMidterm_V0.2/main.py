...
TOTAL_EPOCHS = 15000                      # 總共訓練幾輪
LEARNING_RATE = 0.00005                    # 學習率：每次調整參數的幅度
SEQUENCE_LENGTH = 15                     # 用前面幾個詞預測下一個詞
TEMPERATURE = 0.75                       # 文字生成溫度：越低越保守，越高越有創意
TOP_K = 15                               # Top-k 採樣：只從前 k 個熱門詞中抽樣
PATIENCE = 200                         # 提早停止機制：容忍幾回合 Loss 沒下降
